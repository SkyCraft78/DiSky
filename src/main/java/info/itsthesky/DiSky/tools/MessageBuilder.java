...

{
    ...
    protected boolean isNewLined = false;
     ...
     */
    @Nonnull
    public MessageBuilder append(@Nullable CharSequence text, @Nonnull MessageBuilder.Formatting... format)
    {
     ...
     *
     * <p>This method splits the content if it exceeds 2000 chars. The splitting behaviour can be customized using {@link MessageBuilder.SplitPolicy SplitPolicies}.
     ...
     */
    @Nonnull
    public Queue<Message> buildAll(@Nullable MessageBuilder.SplitPolicy... policy)
    {
        if (this.isEmpty())
        ...
        {
            for (MessageBuilder.SplitPolicy splitPolicy : policy)
            {
    ...
    public MessageBuilder setNewLined(boolean newLined) {
        isNewLined = newLined;
        return this;
    }
    ...
    public interface SplitPolicy
    {
        ...
        /**
         * Creates a new {@link MessageBuilder.SplitPolicy} splitting on the specified chars.
         *
         * @param  chars
         ...
         *
         * @return a new {@link MessageBuilder.SplitPolicy}
         */
        @Nonnull
        static MessageBuilder.SplitPolicy onChars(@Nonnull CharSequence chars, boolean remove)
        {
            return new MessageBuilder.SplitPolicy.CharSequenceSplitPolicy(chars, remove);
        }

        /**
         * Default {@link MessageBuilder.SplitPolicy} implementation. Splits on a specified {@link CharSequence}.
         */
